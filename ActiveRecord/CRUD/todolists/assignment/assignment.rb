...
class Assignment
  ...
  def create_user(params)
      ...
      new_user.password_digest = params[:password_digest]
      new_user.save
  ...
  def create_todolist(params)
      ...
      new_todolist.list_name = params[:name]
      new_todolist.list_due_date = params[:due_date]
      new_todolist.save
  end
  ...
  def find_allusers(offset, limit)
      ...
      found_users = User.offset(offset).limit(limit)
  end
  ...
  def find_alllists(offset, limit)
      ...
      found_lists = TodoList.offset(offset).limit(limit).order(list_due_date: :desc)
  end
